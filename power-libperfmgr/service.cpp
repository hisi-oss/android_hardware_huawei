...
#define LOG_TAG "android.hardware.power-service.huawei-libperfmgr"
...
int main() {
    ...
    LOG(INFO) << "Huawei Power HAL AIDL Service with Extension is starting with config: "
              << config_path;
    ...
    LOG(INFO) << "Huawei Power HAL AIDL Service is started.";
